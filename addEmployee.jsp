<%@ page import= "com.gmu.model.DepartmentStructure"%>
<%@ page import= "com.gmu.model.ManagerStructure"%>
...
<body>
	<%
		List<DepartmentStructure> listDepartment = (List<DepartmentStructure>)request.getAttribute("listDepartment");
	%>
	<%
					...
					<div class="card">
						...
						<div class="card-body">
							<form name="my-form" action="employee" method="post">
								...
								<div class="form-group row">
									<label for="dob" class="col-md-4 col-form-label text-md-right">D.O.B.</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="ssn_number"
										...
										title="Social Security Number">SSN</abbr></label>
									<div class="col-md-6">
								    ...
								    <div class="panel panel-default">
								             ...
								             <h4 class="col-md-6 panel-title">
									            <div class="checkbox">
									                <label class="col-form-label text-md-right" data-toggle="collapse" data-target="#collapseOne">
									                    <input type="checkbox" id="dependent_checkbox" name="dependent_present" value= "have_dependent" onclick="checkForm()"/> Check for Dependent
									                </label>
									            </div>
											</h4>
								        </div>
								        ...
								        <div id="collapseOne" class="panel-collapse collapse in">
								            <div class="panel-body">
												...
												<div class="form-group row">
													<label for="dob" class="col-md-4 col-form-label text-md-right">Dependent D.O.B</label>
													<div class="col-md-6">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<select class="form-control" name="dno">
											<%
												for(DepartmentStructure ld : listDepartment) {
											%>
