<%@ page import= "com.gmu.model.EmployeeStructure"%>
<%@ page import= "com.gmu.model.DependentStructure"%>
<%@ page import= "com.gmu.model.ProjectStructure"%>
				...
				<div class="col-md-8">
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="form-group row">
								<label for="last_name"
									class="col-md-4 col-form-label text-md-right">D.O.B.
									</label>
								<div class="col-md-6">
									<%=employee.getBdate()%>
								</div>
